            ...
            var html = '' +
                ...
                '<div class="mm_accordion">' +
                    '<div data-role="collapsible">' +
                        '<label data-role="title"><span>Menu Column</span></label>' +
                    '</div>' +
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Set column width:</div>' +
                            this.getWidthSelectHtml(data.width) +
                        '</div>' +
                    '</div>' +

                    '<div data-role="collapsible">' +
                        '<label data-role="title"><span>CSS class</span></label>' +
                    '</div>' +
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Enter specific css class:</div>' +
                    ...
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Add subcategory:</div>' +
                    ...
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Select static block:</div>' +
                            '<select class="mm_data_input_control admin__control-select">';
                    ...
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Select product(s):</div>' +
                    ...
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Select widget:</div>' +
                    ...
                    '<div data-role="content" class="mm_data_input">' +
                        '<div class="indent">' +
                            '<div class="sub-title">Add video (insert embedded code including &lt;iframe&gt;):</div>' +
                ...
                '<div class="mm_data_input">' +
                    '<div class="mm_select_wrapper">' +
                        ...
                        '</select>' +
                        '<div class="sub-title">Actions with selected:</div>' +
                        '<button class="mm_up" type="button"></button>' +
                        '<button class="mm_down" type="button"></button>' +
                        '<button class="mm_remove_selected" type="button"></button>' +
                    '</div>' +
                '</div>' +
                // '<div class="mm_remove_column_div">' +
                    '<button class="mm_remove_column_button mm_remove" type="button"></button>' +
                // '</div>' +
